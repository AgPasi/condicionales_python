...
if texto_1 < texto_2:
    print('Texto_1: {0} es menor que Texto_2: {1} '.format(texto_1, texto_2))
...
if text1 > text2:
    print('Text1:{num1} es mayor que Text2: {num2}'.format(num1=text1, num2=text2))
elif text1 < text2:
    print('Text1: {num1} es menor que Text2: {num2}'.format(num1=text1, num2=text2))
else:
    print("Son iguales")
